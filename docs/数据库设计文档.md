...
**外键**：
- `FOREIGN KEY (doctor_id) REFERENCES sys_user(id)`，且目标用户必须为启用中的医生账号
...
- `FOREIGN KEY (create_doctor_id) REFERENCES sys_user(id)`，且目标用户必须为医生账号
...
**外键**：
- `FOREIGN KEY (elder_id) REFERENCES elder_info(id)`
- `FOREIGN KEY (doctor_id) REFERENCES sys_user(id)`，且目标用户必须为医生账号
