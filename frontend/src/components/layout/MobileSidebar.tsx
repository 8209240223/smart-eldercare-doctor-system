...
const menuItems: MenuItem[] = [
  ...
  { path: "/key-population", label: "重点人群", icon: ShieldAlert, roles: ["admin", "doctor"] },
  ...
  { path: "/interventions", label: "干预管理", icon: Stethoscope, roles: ["admin", "doctor"] },
  ...
  { path: "/exams", label: "体检管理", icon: ClipboardList, roles: ["admin", "doctor"] },
  ...
  { path: "/warning-rules", label: "预警规则", icon: Settings, roles: ["admin"] },
