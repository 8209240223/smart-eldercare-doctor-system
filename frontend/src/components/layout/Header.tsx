  ...
  return (
    <motion.header initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="flex h-20 items-center justify-between rounded-2xl border border-border/40 bg-white/80 px-4 shadow-card backdrop-blur-md lg:px-6">
      ...
      <div className="flex items-center gap-2 lg:gap-3">
        ...
        <Button asChild className="hidden rounded-full bg-gradient-to-r from-medical-400 to-medical-600 px-4 text-white shadow-soft hover:shadow-glow md:flex"><Link to="/elders?create=1"><Plus className="mr-2 h-4 w-4" />新增档案</Link></Button>
